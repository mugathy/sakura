...
export const BASE = 'https://mugathy.github.io/sakura/';

export function head(title, description, page) {
  const url = BASE + (page || '');
  const social = `<link rel="canonical" href="${url}">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Sakura Japanese Restaurant">
